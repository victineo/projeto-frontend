    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.sectionContent}>
          ...
          ex exercitationem cum. Vitae commodi repellendus officia ea voluptatibus
          cum similique deleniti, maiores optio necessitatibus quibusdam molestias
          suscipit, eum quos!
        </p>
        <div className={styles.faq}>
          ...
          <div className={styles.question}>
            ...
            <p className={styles.sectionContent}>
              ...
              animi ex exercitationem cum. Vitae commodi repellendus officia ea
              voluptatibus cum similique deleniti, maiores optio necessitatibus
              quibusdam molestias suscipit, eum quos!
            </p>
          </div>
          <div className={styles.question}>
        ...
        <div>
          ...
          <p className={styles.sectionContent}>
            Entre em contato com a gente nos canais abaixo:
          </p>
          <div className={styles.contactInfo}>
            ...
            <p>
              Instagram :{" "}
              <a href="https://instagram.com/nome_da_empresa">@nome_da_empresa</a>
            </p>
          </div>
        </div>
      </div>
